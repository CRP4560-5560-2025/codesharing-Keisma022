README – CRP 4560/5560 Code Sharing Assignment
Author: Kolton Eisma
...
CSV Note: The toolbox expects a join-ready CSV with one row per tract.
Required join field: Geography (e.g., “Census Tract 1.01”)
Required value field: one numeric column (e.g., SNAP estimate)
...
Outputs are saved to a folder named outputs located in the same directory as the toolbox file to improve portability across computers.
